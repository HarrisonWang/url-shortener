  ...
  return (
    <main className="flex flex-col items-center gap-4 w-full">
      ...
      <div className="w-full max-w-3xl bg-[#F1F0E2] p-6 rounded-2xl mt-4">
        ...
        <p className="mb-4">
          This website was developed by <a href="https://x.com/voywang" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Harrison Wang</a>. While not a professional developer, I successfully created this tool with the help of AI. The entire project was developed using <a href="https://www.cursor.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Cursor</a> and designed in <a href="https://www.figma.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Figma</a>.
        </p>
        <div className="mt-6">
